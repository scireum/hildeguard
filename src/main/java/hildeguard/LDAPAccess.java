...
public class LDAPAccess {
    ...
    public Optional<SearchResult> searchUser(DirContext ctx, String username) throws NamingException {
        ...
        NamingEnumeration<SearchResult> answer =
                ctx.search(searchBase, Formatter.create(searchFilter).set("user", username).format(), searchCtls);
    ...
    public Stream<String> readRoles(SearchResult sr) throws NamingException {
